...
public class PasswordEncryptionGatewayArgon2 implements PasswordEncryptionGateway {
    ...
    private final String pepper = "mesa_maestra@2024";
    ...
    public String hashPassword(String password) {
        ...
        int memory = 65536;
        int parallelism = 1;
        return argon2.hash(iterations, memory, parallelism, (password + this.pepper).toCharArray());
    }

    @Override
    public boolean isPasswordValid(String hashedPassword, String password) {
        return this.argon2.verify(hashedPassword, (password + this.pepper).toCharArray());
    }
}
